					...
					<div class="span7">
						<form class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="treeName2">菜单ID</label>
								<div class="controls">
									<input type="text" name="treeId" id="treeId2" readonly="readonly" maxlength="20"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="treeName2">菜单名(权限组名)</label>
								<div class="controls">
									<input type="text" name="treename" id="treeName2" maxlength="20"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="description2">菜单链接URI</label>
								<div class="controls">
									<input type="text" name="description" id="description2" maxlength="128" class="span10"/>
								</div>
							</div>
									...
									<table class="table table-hover">
										...
										<tbody>
											<tr>
												...
												<td><input /></td>
												<td>
													<a href="#" class="privilege-add btn">添加</a>
													<a href="#" class="privilege-remove btn btn-danger">删除</a>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="form-actions">
								...
								<a href="#" id="btnAddMenu" onclick="" class="btn btn-primary">提交</a>
...
function onClick(event, ztree, treeNode){
	...
	$("#treeName2").val(treeNode.name);
	$("#description2").val(treeNode.url);
	// alert("click");
}
