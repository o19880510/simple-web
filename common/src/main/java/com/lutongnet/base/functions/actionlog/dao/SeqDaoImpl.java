...
public class SeqDaoImpl extends EntityDaoSupport<Seq> implements SeqDao {
	...
	private static final String UPDATE_SEQ_NEXT_VALUE = " UPDATE Seq SET "
		...
		+" WHERE tableName = ? ";
	/* (non-Javadoc)
	 * @see com.lutongnet.base.functions.actionlog.dao.ISeqDao#updateSeqNextValue(com.lutongnet.base.functions.actionlog.model.entity.Seq)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lutongnet.base.functions.actionlog.dao.ISeqDao#get(java.io.Serializable)
	 */
	@Override
